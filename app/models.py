...
class QueryRequest(BaseModel):
    ...
    search_mode: Literal["dense", "sparse", "colbert", "hybrid"] = Field(
        default="hybrid",
        description="Search mode: dense (semantic), sparse (keyword), colbert (multi-vector), or hybrid (RRF fusion)"
    )
...
class QueryResponse(BaseModel):
    ...
    answer: str
    mode: str
    search_mode: Literal["dense", "sparse", "colbert", "hybrid"]
